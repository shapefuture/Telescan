...
async def _process(monitored_chat_db_id, request_id, is_manual_run):
    ...
    from app.shared.db_crud import update_monitored_chat_prompt
    ...
    async with async_sessionmaker() as session:
        ...
        if not mc:
            _publish_status(request_id, "FAILED", "MonitoredChat not found")
            return
        ...
        try:
            ...
            _publish_status(request_id, "FAILED", f"tdl export failed: {e}")
            return
        # Clean messages
        ...
        try:
            ...
            participants_txt_path = None  # Not fatal for channels
            _publish_status(request_id, "TDL_PARTICIPANTS_EXPORT_FAILED", str(e))
        ...
        try:
            ...
            _publish_status(request_id, "FAILED", f"LLM failed: {e}")
            return
